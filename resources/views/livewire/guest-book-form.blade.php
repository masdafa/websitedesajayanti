                        ...
                        <form wire:submit.prevent="submit" class="space-y-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input type="text" wire:model.defer="name" class="w-full rounded-xl border-gray-200 shadow-sm focus:border-emerald-500 focus:ring focus:ring-emerald-200 transition" placeholder="Nama Lengkap" required>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input type="text" wire:model.defer="origin" class="w-full rounded-xl border-gray-200 shadow-sm focus:border-emerald-500 focus:ring focus:ring-emerald-200 transition" placeholder="Misal: Keluarga Bpk. X, Dinas Kesehatan, dll">
                                ...
                                <div>
                                    ...
                                    <input type="datetime-local" wire:model.defer="visit_date" class="w-full rounded-xl border-gray-200 shadow-sm focus:border-emerald-500 focus:ring focus:ring-emerald-200 transition">
                            ...
                            <div>
                                ...
                                <textarea wire:model.defer="purpose" rows="4" class="w-full rounded-xl border-gray-200 shadow-sm focus:border-emerald-500 focus:ring focus:ring-emerald-200 transition" placeholder="Sebutkan tujuan kunjungan Anda..." required></textarea>
