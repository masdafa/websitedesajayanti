@props(['totalResidents' => 0, 'totalHouses' => 0, 'totalFacilities' => 0])
...
<div class="py-12 bg-white relative z-10">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-2 md:grid-cols-4 gap-6 lg:gap-8">
            @php
            $formattedResidents = $totalResidents > 0 ? number_format($totalResidents, 0, ',', '.') : '2.500+';
            $formattedHouses = $totalHouses > 0 ? number_format($totalHouses, 0, ',', '.') : '800+';
            $formattedFacilities = $totalFacilities > 0 ? $totalFacilities : '8';
            $quickStats = [
                ['icon' => 'M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z', 'value' => $formattedResidents, 'label' => 'Warga', 'color' => 'emerald'],
                ['icon' => 'M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6', 'value' => $formattedHouses, 'label' => 'Unit Rumah', 'color' => 'blue'],
                ...
                ['icon' => 'M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4', 'value' => $formattedFacilities, 'label' => 'Fasilitas', 'color' => 'amber'],
            ];
