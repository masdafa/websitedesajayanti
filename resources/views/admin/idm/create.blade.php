<x-admin-layout title="Tambah Data IDM">
    <x-slot:breadcrumb>Tambahkan rekap data Indeks Desa Membangun</x-slot:breadcrumb>

    <div class="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden max-w-4xl">
        <form action="{{ route('admin.idm.store') }}" method="POST" class="p-6 sm:p-8 space-y-6">
            @csrf
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="number" step="0.0001" name="score" value="{{ old('score') }}" required
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-xl focus:ring-emerald-500 focus:border-emerald-500 block w-full px-4 py-3"
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-6">
                ...
                <div>
                    ...
                    <input type="number" step="0.0001" name="social_index" value="{{ old('social_index') }}" required
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-xl focus:ring-emerald-500 focus:border-emerald-500 block w-full px-4 py-3"
                ...
                <div>
                    ...
                    <input type="number" step="0.0001" name="economic_index" value="{{ old('economic_index') }}" required
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-xl focus:ring-emerald-500 focus:border-emerald-500 block w-full px-4 py-3"
                ...
                <div>
                    ...
                    <input type="number" step="0.0001" name="environmental_index" value="{{ old('environmental_index') }}" required
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-xl focus:ring-emerald-500 focus:border-emerald-500 block w-full px-4 py-3"
