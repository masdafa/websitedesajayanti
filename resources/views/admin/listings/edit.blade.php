<x-admin-layout title="Edit Listing">
    <x-slot:breadcrumb>Ubah data tempat atau fasilitas di desa</x-slot:breadcrumb>

    <div class="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden max-w-4xl">
        <form action="{{ route('admin.listings.update', $listing) }}" method="POST" enctype="multipart/form-data" class="p-6 sm:p-8 space-y-6">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <div class="sm:col-span-2">
                    ...
                    <textarea name="address" rows="2"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-xl focus:ring-emerald-500 focus:border-emerald-500 block w-full px-4 py-3"
                        placeholder="Detail alamat lokasi...">{{ old('address', $listing->address) }}</textarea>
                ...
                <div>
                    ...
                    <input type="text" name="phone_number" value="{{ old('phone_number', $listing->phone_number) }}"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-xl focus:ring-emerald-500 focus:border-emerald-500 block w-full px-4 py-3"
                ...
                <div>
                    ...
                    <input type="url" name="maps_url" value="{{ old('maps_url', $listing->maps_url) }}"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-xl focus:ring-emerald-500 focus:border-emerald-500 block w-full px-4 py-3"
            ...
            <div>
                ...
                <textarea name="description" rows="4"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-xl focus:ring-emerald-500 focus:border-emerald-500 block w-full px-4 py-3"
                    placeholder="Jelaskan mengenai tempat/fasilitas ini...">{{ old('description', $listing->description) }}</textarea>
            ...
            <div>
                ...
                @if($listing->image)
                    <div class="mb-4">
                        <div class="w-32 h-24 rounded-xl bg-gray-100 overflow-hidden border border-gray-200 shadow-sm">
