<x-admin-layout title="Kelola Laporan Iuran Ruko">
    <x-slot:breadcrumb>Kelola data grafik laporan iuran kas Ruko per tahun</x-slot:breadcrumb>
    ...
    <div class="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden mb-8">
        ...
        <div class="p-6">
            <form action="{{ route('admin.ruko-financial-reports.store') }}" method="POST" class="grid grid-cols-1 md:grid-cols-5 gap-4 items-end">
                @csrf
