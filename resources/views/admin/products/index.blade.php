                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center gap-4">
                                    <div class="w-16 h-16 rounded-xl bg-gray-100 overflow-hidden border border-gray-200 flex-shrink-0">
                                        @if((!empty($product->images) ? $product->images[0] : null))
                                            <img src="{{ Str::startsWith((!empty($product->images) ? $product->images[0] : null), 'http') ? (!empty($product->images) ? $product->images[0] : null) : asset('storage/'.(!empty($product->images) ? $product->images[0] : null)) }}" class="w-full h-full object-cover">
                                        @else
