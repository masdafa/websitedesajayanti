<x-admin-layout title="Edit Info Iuran">
    <x-slot:breadcrumb>
    ...
    <div class="bg-white border border-gray-200 rounded-2xl shadow-sm overflow-hidden max-w-3xl">
        <div class="p-6">
            <form action="{{ route('admin.iuran.update', $iuran) }}" method="POST" class="space-y-6">
                @csrf
                @method('PUT')
                
                <div>
                    <label class="block text-sm font-semibold text-gray-900 mb-2">Judul Info Iuran <span class="text-red-500">*</span></label>
                    <input type="text" name="title" value="{{ old('title', $iuran->title) }}" required class="w-full rounded-xl border-gray-200 shadow-sm focus:border-emerald-500 focus:ring focus:ring-emerald-200 transition">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="number" name="amount" value="{{ old('amount', $iuran->amount) }}" class="w-full pl-12 rounded-xl border-gray-200 shadow-sm focus:border-emerald-500 focus:ring focus:ring-emerald-200 transition">
                    </div>
                ...
                <div>
                    ...
                    <textarea name="description" rows="5" required class="w-full rounded-xl border-gray-200 shadow-sm focus:border-emerald-500 focus:ring focus:ring-emerald-200 transition">{{ old('description', $iuran->description) }}</textarea>
                ...
                <div class="grid grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="number" name="sort_order" value="{{ old('sort_order', $iuran->sort_order) }}" class="w-full rounded-xl border-gray-200 shadow-sm focus:border-emerald-500 focus:ring focus:ring-emerald-200 transition">
                    </div>
                    ...
                    <div>
                        ...
                        <label class="inline-flex items-center mt-2 cursor-pointer">
                            <input type="checkbox" name="is_active" value="1" class="rounded border-gray-300 text-emerald-600 shadow-sm focus:border-emerald-300 focus:ring focus:ring-emerald-200 focus:ring-opacity-50 w-5 h-5" {{ old('is_active', $iuran->is_active) ? 'checked' : '' }}>
