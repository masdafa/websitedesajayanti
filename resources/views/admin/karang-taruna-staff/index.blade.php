<x-admin-layout title="Pengurus Karang Taruna">
    ...
    <div class="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
        ...
        <div class="p-4 sm:p-6 border-b border-gray-100 flex items-center justify-between">
            <h2 class="font-bold text-gray-800">Daftar Pengurus Karang Taruna</h2>
            <a href="{{ route('admin.karang-taruna-staff.create') }}" class="bg-emerald-600 hover:bg-emerald-700 text-white font-semibold py-2.5 px-5 rounded-xl transition flex items-center gap-2 text-sm">
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-sm text-left text-gray-600">
                ...
                <tbody class="divide-y divide-gray-100">
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 text-right">
                                <div class="flex items-center justify-end gap-2">
                                    <a href="{{ route('admin.karang-taruna-staff.edit', $s) }}" class="p-2 text-blue-600 bg-blue-50 hover:bg-blue-100 rounded-lg transition">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z"/></svg>
                                    </a>
                                    <form action="{{ route('admin.karang-taruna-staff.destroy', $s) }}" method="POST" onsubmit="return confirm('Hapus pengurus ini?')">
                                        @csrf @method('DELETE')
                    ...
                    @empty
                        <tr><td colspan="4" class="px-6 py-12 text-center text-gray-400">Belum ada data pengurus Karang Taruna.</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
