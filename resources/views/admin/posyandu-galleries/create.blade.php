<x-admin-layout title="Tambah Dokumentasi Posyandu">
    <x-slot:breadcrumb>Unggah foto dokumentasi kegiatan Posyandu baru</x-slot:breadcrumb>
    <div class="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden max-w-2xl">
        <form action="{{ route('admin.posyandu-galleries.store') }}" method="POST" enctype="multipart/form-data" class="p-6 sm:p-8 space-y-5">
            @csrf
            <div>
                ...
                <input type="text" name="title" value="{{ old('title') }}" required
                    ...
                    placeholder="Contoh: Kegiatan Imunisasi Balita Bulan Agustus">
