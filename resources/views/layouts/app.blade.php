...
<body class="antialiased text-gray-900 bg-gray-50">
    <div class="min-h-screen flex flex-col relative">
        ...
        <header x-data="{ scrolled: false, mobileMenuOpen: false }"
                ...
                class="fixed z-50 transition-all duration-500 w-full left-0 right-0 top-0"
                :class="scrolled ? 'nav-glass shadow-2xl py-3' : 'py-6 ' + ($isHome ? 'bg-transparent' : 'nav-glass shadow-xl py-4')">
            ...
            <div x-show="mobileMenuOpen"
                ...
                <div class="px-4 py-4 flex flex-col space-y-1 max-h-[70vh] overflow-y-auto">
                    ...
                    <a href="/pengurus" class="text-white font-semibold px-4 py-2.5 rounded-xl hover:bg-white/10 flex items-center gap-2 transition" wire:navigate @click="mobileMenuOpen=false">
                        <svg class="w-5 h-5 text-green-300" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"/></svg>
                        Struktur Pengurus
                    </a>
                    <a href="/dkm" class="text-white font-semibold px-4 py-2.5 rounded-xl hover:bg-white/10 flex items-center gap-2 transition" wire:navigate @click="mobileMenuOpen=false">
                        <svg class="w-5 h-5 text-green-300" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"/></svg>
                        DKM Masjid
                    </a>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
                    ...
                    <div class="md:col-span-1">
                        ...
                        <p class="text-sm text-green-300 leading-relaxed italic">"Bersama Membangun Lingkungan yang Aman, Nyaman, Bersih, dan Harmonis."</p>
                    </div>
                    ...
                    <div>
                        ...
                        <ul class="space-y-3 text-sm text-green-300">
                            <li class="flex items-start gap-2.5">
                                ...
                                Jl. Jayanti Residence RW 09 Desa Jayanti Kabupaten Tangerang -Banten
                            </li>
                            ...
                            <li class="flex items-center gap-2.5">
                                <svg class="w-4 h-4 text-green-500 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
